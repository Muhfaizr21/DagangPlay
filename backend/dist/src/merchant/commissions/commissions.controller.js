...
let CommissionsController = class CommissionsController {
    commissionsService;
    prisma;
    constructor(commissionsService, prisma) {
        this.commissionsService = commissionsService;
        this.prisma = prisma;
    }
    async getCommissions(req) {
    ...
    async settleAllCommissions(req) {
        const merchant = await this.prisma.merchant.findUnique({ where: { ownerId: req.user.id } });
        if (!merchant)
            throw new Error('Merchant not found');
        return this.commissionsService.settleCommissions(merchant.id);
    }
    async settleResellerCommissions(req, resellerId) {
        const merchant = await this.prisma.merchant.findUnique({ where: { ownerId: req.user.id } });
        if (!merchant)
            throw new Error('Merchant not found');
...
], CommissionsController.prototype, "getCommissions", null);
__decorate([
    ...
    __metadata("design:paramtypes", [Object]),
    __metadata("design:returntype", Promise)
], CommissionsController.prototype, "settleAllCommissions", null);
__decorate([
    (0, common_1.Post)('settle/:resellerId'),
    __param(0, (0, common_1.Request)()),
    __param(1, (0, common_1.Param)('resellerId')),
    __metadata("design:type", Function),
    __metadata("design:paramtypes", [Object, String]),
    __metadata("design:returntype", Promise)
], CommissionsController.prototype, "settleResellerCommissions", null);
exports.CommissionsController = CommissionsController = __decorate([
    ...
    (0, common_1.Controller)('merchant/commissions'),
    __metadata("design:paramtypes", [commissions_service_1.CommissionsService, prisma_service_1.PrismaService])
