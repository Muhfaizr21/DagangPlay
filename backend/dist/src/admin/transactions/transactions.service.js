...
let TransactionsService = class TransactionsService {
    ...
    publicOrders;
    fulfillmentQueue;
    constructor(prisma, publicOrders, fulfillmentQueue) {
        this.prisma = prisma;
    ...
    async refundTransaction(id, operatorId) {
        ...
        if (order.fulfillmentStatus === 'SUCCESS')
            throw new common_1.BadRequestException('Tidak bisa refund: Produk sudah berhasil dikirim ke pelanggan. Hubungi supplier terlebih dahulu untuk pembatalan.');
...
exports.TransactionsService = TransactionsService = __decorate([
    ...
    __param(2, (0, bullmq_1.InjectQueue)('digiflazz-fulfillment')),
