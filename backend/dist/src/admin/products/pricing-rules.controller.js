...
let PricingRulesController = class PricingRulesController {
    ...
    async updateCategoryRule(id, dto) {
    ...
    async applyCategoryRule(categoryId, margins) {
...
], PricingRulesController.prototype, "getCategoryRules", null);
__decorate([
    ...
    __metadata("design:returntype", Promise)
], PricingRulesController.prototype, "createCategoryRule", null);
__decorate([
    ...
    __metadata("design:returntype", Promise)
], PricingRulesController.prototype, "updateCategoryRule", null);
__decorate([
    ...
    __metadata("design:returntype", Promise)
], PricingRulesController.prototype, "deleteCategoryRule", null);
__decorate([
    (0, common_1.Post)('apply-category/:categoryId'),
    __param(0, (0, common_1.Param)('categoryId')),
    __param(1, (0, common_1.Body)()),
    __metadata("design:type", Function),
    __metadata("design:paramtypes", [String, Object]),
    __metadata("design:returntype", Promise)
], PricingRulesController.prototype, "applyCategoryRule", null);
exports.PricingRulesController = PricingRulesController = __decorate([
    ...
    (0, permissions_decorator_1.Permissions)('manage_products'),
    (0, common_1.Controller)('admin/pricing-rules'),
