...
export class PromosService {
  ...
  async updatePromo(id: string, data: any) {
    ...
    if (updateData.maxDiscount !== undefined)
      updateData.maxDiscount = updateData.maxDiscount
        ? Number(updateData.maxDiscount)
        : null;
    if (updateData.minPurchase !== undefined)
      updateData.minPurchase = updateData.minPurchase
        ? Number(updateData.minPurchase)
        : null;
  ...
  async deletePromo(id: string) {
    ...
    const usages = await this.prisma.promoUsage.count({
