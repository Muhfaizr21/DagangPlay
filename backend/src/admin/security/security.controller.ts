import { UseGuards,  Controller, Get, Post, Delete, Body, Param, Query, HttpCode  } from "@nestjs/common";
...
export class SecurityController {
    ...
    @Get('audit')
    async getAuditLogs(@Query('startDate') startDate?: string, @Query('action') action?: string) {
