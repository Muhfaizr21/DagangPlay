...
async function syncAllDigiflazzProducts() {
  try {
    ...
    const allRules = await prisma.tierPricingRule.findMany({
      where: { isActive: true },
    });
    ...
    for (const item of gameItems) {
      try {
        ...
        const gameThumbnails: Record<string, string> = {
          ...
          'ARENA OF VALOR':
            'https://cdn1.codashop.com/S/content/common/images/mno/Aov600x600.png',
          'HONKAI STAR RAIL':
            'https://cdn1.codashop.com/S/content/common/images/mno/HonkaiStarRail600x600.png',
          'HONOR OF KINGS':
          ...
          'GOOGLE PLAY INDONESIA':
            'https://cdn1.codashop.com/S/content/common/images/mno/GooglePlay600x600.png',
          'STEAM WALLET (IDR)':
            'https://cdn1.codashop.com/S/content/common/images/mno/Steam600x600.png',
          'UNIPIN VOUCHER':
            'https://cdn1.codashop.com/S/content/common/images/mno/Unipin600x600.png',
          GARENA:
            'https://cdn1.codashop.com/S/content/common/images/mno/Garena600x600.png',
          'RAZER GOLD':
            'https://cdn1.codashop.com/S/content/common/images/mno/RazerGold600x600.png',
          'SAUSAGE MAN':
            'https://cdn1.codashop.com/S/content/common/images/mno/SausageMan600x600.png',
          'STUMBLE GUYS':
            'https://cdn1.codashop.com/S/content/common/images/mno/StumbleGuys600x600.png',
          VIDIO:
            'https://cdn1.codashop.com/S/content/common/images/mno/Vidio600x600_2.png',
          SPOTIFY:
            'https://cdn1.codashop.com/S/content/common/images/mno/Spotify600x600_premium.png',
        };
        const thumbnail =
        ...
        const rule =
          allRules.find((r) => r.categoryId === category.id) || globalRule;
    ...
    for (const sku of allSkus) {
      if (sku._count.orders > 0) {
        ...
        await prisma.tierPriceHistory.deleteMany({
          where: { productSkuId: sku.id },
        });
        await prisma.merchantProductPrice.deleteMany({
          where: { productSkuId: sku.id },
        });
