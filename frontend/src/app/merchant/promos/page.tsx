...
export default function MerchantPromosPage() {
    const { data: promos, mutate, error } = useSWR((getApiUrl()) + '/merchant/promos', fetcher);
    // Tambah untuk Flash Sale Data
    const { data: flashSales, mutate: mutateFS } = useSWR((getApiUrl()) + '/merchant/promos/flash-sales', fetcher);
    const { data: productsData } = useSWR((getApiUrl()) + '/merchant/products', fetcher);
    ...
    const handleCreatePromo = async (e: React.FormEvent) => {
        ...
        try {
            ...
            await axios.post((getApiUrl()) + '/merchant/promos', {
                ...form,
    ...
    const handleToggle = async (id: string, currentStatus: boolean) => {
        try {
            const token = localStorage.getItem('admin_token');
            await axios.put(`${getApiUrl()}/merchant/promos/${id}/toggle`, { isActive: !currentStatus }, { headers: { Authorization: `Bearer ${token}` } });
            mutate();
        } catch (err: any) {
    ...
    const handleDelete = async (id: string) => {
        ...
        try {
            const token = localStorage.getItem('admin_token');
            await axios.delete(`${getApiUrl()}/merchant/promos/${id}`, { headers: { Authorization: `Bearer ${token}` } });
            mutate();
        } catch (err: any) {
    ...
    const handleCreateFS = async (e: React.FormEvent) => {
        ...
        try {
            ...
            await axios.post((getApiUrl()) + '/merchant/promos/flash-sales', {
                name: fsForm.name,
    ...
    const handleToggleFS = async (id: string, currentStatus: boolean) => {
        try {
            const token = localStorage.getItem('admin_token');
            await axios.put(`${getApiUrl()}/merchant/promos/flash-sales/${id}/toggle`, { isActive: !currentStatus }, { headers: { Authorization: `Bearer ${token}` } });
            mutateFS();
        } catch (err: any) {
    ...
    const handleDeleteFS = async (id: string) => {
        ...
        try {
            const token = localStorage.getItem('admin_token');
            await axios.delete(`${getApiUrl()}/merchant/promos/flash-sales/${id}`, { headers: { Authorization: `Bearer ${token}` } });
            mutateFS();
        } catch (err: any) {
